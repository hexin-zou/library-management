...
<!--      <el-table-column prop="id" label="编号" width="80"></el-table-column>-->
      ...
      <el-table-column label="操作" width="280">
        <template v-slot="scope">
          <!--          scope.row 就是当前行数据-->
          <el-button round type="success" v-if="!scope.row.pid" @click="handleAdd(scope.row)">添加二级分类</el-button>
        </template>
      </el-table-column>
      <el-table-column fixed="right" label="操作" width="100">
        <template slot-scope="scope">
          <el-button round type="primary" @click="$router.push('/editCategory?id=' + scope.row.id)">编辑</el-button>
        </template>
      </el-table-column>
      <el-table-column fixed="right" label="操作" width="100">
        <template slot-scope="scope">
    ...
    <el-dialog title="添加二级分类" :visible.sync="dialogFormVisible" width="30%">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button round type="primary" @click="save">确 定</el-button>
      </div>
    </el-dialog>
