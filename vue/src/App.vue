<template>
  <div id="app">
    <!--头部区域-->
    <div style="height:60px; line-height:60px;margin-top: 0; background-color:darkgrey">
    ...
    <div style="display:flex">  <!--弹性盒子-->
      <!--侧边栏导航-->                  <!--页面高度-->
      <div style="width:200px;min-height:100px;overflow: hidden;margin-right: 1px;margin-left: 0; background-color: lightgray">
      ...
      <!--主体数据-->
      <div style="flex:1; min-height: calc(120vh - 40px);margin-right:2px;background-color: lightgray;">
        <router-view/>
      </div>
    </div>
  </div>
